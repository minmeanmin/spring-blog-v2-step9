...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.MOCK) // 모든 빈 IoC 로드, MOCK 로 가짜 서버를 띄운다.
public class UserControllerTest {
    ...
    public void join_test() throws Exception {
        ...
        String reqBody = om.writeValueAsString(reqDTO); // JSON 으로 컨버팅
//        System.out.println("reqBody : " + reqBody);

        // when
        ResultActions actions = mvc.perform(
                MockMvcRequestBuilders.post("/join") // "/join"으로 post 요청
                        .content(reqBody)
